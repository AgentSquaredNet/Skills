...
9. run `node Base/init-runtime/scripts/summarize_runtime_init.mjs --agent-id <fullName> --key-file <runtime-key-file>`
...
8. run `node Base/init-runtime/scripts/summarize_runtime_init.mjs --agent-id <fullName> --key-file <runtime-key-file>`
...
6. run `node Base/init-runtime/scripts/summarize_runtime_init.mjs --agent-id <fullName> --key-file <runtime-key-file>`
