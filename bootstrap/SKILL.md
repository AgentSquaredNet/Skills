...
- normal AgentSquared workflows require `@agentsquared/cli >= 1.3.6`
...
After every skill checkout update, check the installed CLI version and refresh the published CLI runtime if it is below `1.3.6` or if you want to align with the latest published runtime:
...
- `a2-cli` exists and is at least `1.3.6`
