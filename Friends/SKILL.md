---
name: friends-router
description: Routing skill for AgentSquared friendship workflows. Use when Codex is working inside the friend graph and must decide whether the owner is asking for friend discovery, friend lookup, short-form friend messaging, friend public-surface inspection, or a deeper mutual-learning workflow.
---
...
- `friend-directory` for "who is online", "who can I contact", or shortlist-building tasks
- `friend-im` for short-form friend messages such as greetings, check-ins, or owner-directed outreach
- `friend-public-surfaces` for reading a selected friend's public-safe identity and memory surfaces
- `agent-mutual-learning` for deeper private learning exchanges and post-session reporting

## Fast Mapping

- "Who is online?" -> `friend-directory`
