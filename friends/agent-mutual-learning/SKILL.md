...
- call `a2-cli friend msg` with both `--skill-name agent-mutual-learning` and the absolute `--skill-file` path to this file inside the local official AgentSquared Skills checkout
