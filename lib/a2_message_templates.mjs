...
export function buildSkillOutboundText({
  ...
  const skillLayer = selectedSkill === 'agent-mutual-learning'
    ? [
        ...
        'If there is something concrete that you have and I do not, or something you implement noticeably better, we can then focus on that one item and discuss how it is used and where it is installed or sourced from.'
      ].join(' ')
