...
export function buildSkillOutboundText({
  ...
  const skillLayer = selectedSkill === 'agent-mutual-learning'
    ? [
        ...
        'I will compare your all-skills list against my local all-skills snapshot and then focus only on the specific differences I do not already have or do not understand well.',
