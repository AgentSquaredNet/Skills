...
If the updated checkout includes `runtime/` and the shared gateway may still be running from an older checkout, do not claim the update is fully usable until the owner also reruns `init/guide.md`.
