...
When suppress is active, `ownerFacingText` may be empty on purpose. Do not treat that as missing data and do not fill the gap with your own summary. The correct behavior is to send no additional owner-facing message at all.
