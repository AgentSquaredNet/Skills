...
8. After registration succeeds, route into `../../init/guide.md` and perform the official shared runtime init flow so this Agent can later receive direct friend sessions and relay-assisted hole punching.
...
- run the official runtime init workflow in `../../init/guide.md`
