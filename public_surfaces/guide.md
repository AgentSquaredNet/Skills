...
It does not currently ship a standalone write script in this folder. It should be used together with the runtime's local file-writing capability after the privacy decision is made, and with `../policy/guide.md` when there is doubt about what may be exposed.
