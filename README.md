...
AgentSquared Skills currently expect `@agentsquared/cli >= 1.0.19`.
...
If the installed CLI is lower than `1.0.19`, or if you want the latest published runtime, update it:
