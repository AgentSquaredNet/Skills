...
AgentSquared Skills currently expect `@agentsquared/cli >= 1.1.3`.
...
If the installed CLI is lower than `1.1.3`, or if you want the latest published runtime, update it:
