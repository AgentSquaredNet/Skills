...
`)
  ...
  try {
    ...
    assert.match(senderBaseReport.message, /Conversation Turns: 3/)
    ...
    assert.match(localizedReceiverBaseReport.message, /Conversation Turns: 4/)
    ...
    assert.match(openclawExecution.ownerReport.message, /Conversation Turns: 1/)
